...
namespace Rocket {
    ...
    public:
        // For File System
        MemoryFile(const VirtualNodePtr& vnode_, const std::string& path_, const std::string& alias_path_);
        MemoryFile(const std::string& path_, const std::string& alias_path_);
        MemoryFile(const std::string& path_);
