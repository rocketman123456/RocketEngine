...
const VkInstanceCreateInfo createInfo = {
    ...
    nullptr,
    2,
    (const char* const[])(VK_KHR_SURFACE_EXTENSION_NAME, VK_KHR_WIN32_SURFACE_EXTENSION_NAME),
};
...
const VkInstanceCreateInfo createInfoLunarGValidation = {
    ...
    3,
    (const char* const[]) (VK_KHR_SURFACE_EXTENSION_NAME, VK_KHR_WIN32_SURFACE_EXTENSION_NAME, VK_EXT_DEBUG_REPORT_EXTENSION_NAME),
};
...
void draw_frame()
{
    ...
    VkClearColorValue clearColorValue = {1.0f, 0, 0, 1.0f};
